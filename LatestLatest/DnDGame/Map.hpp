...
public:
	Point(LOCATION sPointLocation, const std::string& strPointDescription = "", bool bHasVisited = false,
		POINT_TYPE ePointType = POINT_TYPE_GENERIC, bool bCanMonsterEnter = false, POINT_VISIBILITY ePointVisibility = POINT_VISIBILITY_OPEN);
	LOCATION GetLocation() const;
	POINT_TYPE GetPointType() const;
	POINT_VISIBILITY GetPointVisibility() const;
...
private:
	...
	bool m_bCanMonsterEnter;
	POINT_VISIBILITY m_ePointVisibility;
};
