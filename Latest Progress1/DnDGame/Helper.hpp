...
{
	MONSTER_ATTRIBUTES(int nStrength = 10, int nHealth = 20, int nVisibilityThreshold = 10, MONSTER_TYPE eType = MONSTER_TYPE_UNKNOWN, int nMovementFactor = 5, int nAggression = 5) :
...
{
	PLAYER_ATTRIBUTES(int nStrength = 10, int nHealth = 20) :
		m_nStrength(nStrength), m_nHealth(nHealth)
	{
	}
