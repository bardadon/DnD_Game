...
{
	m_sMonsterAttributes.m_nHealth -= Damage;
}

int Monster::GetHealth() const
{
	return m_sMonsterAttributes.m_nHealth;
}
...
Weapon::Weapon(WEAPON_TYPE eWeaponType, int nRangeInSquares) :
	m_eWeaponType(eWeaponType), m_nRangeInSquares(nRangeInSquares)
{
}
...
int ShortSword::Damage() const
{
	return Helper::RollD(6);
}
