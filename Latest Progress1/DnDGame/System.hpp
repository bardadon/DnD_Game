...
public:
	Player();
	Player(PLAYER_ATTRIBUTES m_ePlayerAttributes);
	~Player() = default;
...
public:
	...
	*/
	...
	bool BeginCombat(Monster* vMonsterInCombat);
	void HandleMonsterTurn(Monster* vMonsterInCombat);
	void HandlePlayerTurn(Monster* vMonsterInCombat);
