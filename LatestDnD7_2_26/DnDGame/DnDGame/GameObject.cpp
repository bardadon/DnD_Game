...
{
	if (!sMonsterLocation.IsValidLocation())
	{
		std::cout << "Monster::SetLocation:: Monster location is not valid\n";
		return;
	}
...
{
	m_sMonsterAttributes.m_nAggression = 80;
	...
	m_sMonsterAttributes.m_sSkills.m_nVision = 15;
	m_sMonsterAttributes.m_sSkills.m_nVisibility = 5;
